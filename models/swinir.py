...
class SwinIR(nn.Module):
    ...
    def __init__(self, img_size=126, patch_size=1, in_chans=3,
                 ...
                 use_checkpoint=False, upscale=1, img_range=255., upsampler='', resi_connection='1conv',
                 **kwargs,
                ):
